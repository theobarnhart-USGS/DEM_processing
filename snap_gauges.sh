...
v.in.ascii -t in=/home/tbarnhart/projects/DEM_processing/data/CATCHMENT_region_${1}.csv out=gauges x=24 y=25 cat=26 sep=comma format=point skip=1 --overwrite --quiet # import ascii data, don't make table
